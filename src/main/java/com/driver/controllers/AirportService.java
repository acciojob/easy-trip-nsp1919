...
public class AirportService {
    ...
    {
        Map<String,Airport> map=airportRepository.getAirportMap();
    ...
    public  String bookATicket(Integer flightId,Integer passangerId)
    {
        ...
        Map<Integer,List<Flight>>bookedFlightByPassanger=airportRepository.getBookedFlightByPassanger();
        Map<Integer, Passenger>passengerMap=airportRepository.getPassengerMap();
        Map<Integer, Flight>flightMap=airportRepository.getFlightMap();
        ...
        Map<Integer, List<Passenger>>flightPassangerMap=airportRepository.getFlightPassangerMap();
